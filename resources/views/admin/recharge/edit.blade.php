        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                <div class="widget-content">
                    <form class="form-horizontal mt-5" action="{{url('recharge-update', $balance->id)}}" method="PATCH" enctype="multipart/form-data">
                        {{ method_field('PATCH')}}
                        {{csrf_field()}}
                    <div class="row">
                        <div class="span6">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="number" name="recharge_amount" min="1" value="{{$recharge->recharge_amount}}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="span6">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="ref_number" value="{{$recharge->ref_number}}">
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    {!! Form::select('recharge_type',  ['1' => 'Cash', '2' => 'Cheque', '3' => 'Bkash', '4' => 'Rocket'], null, [ 'placeholder' => 'Select Recharge Type']) !!}
                                </div>          
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <textarea class="span11" name="remarks" value="{{$recharge->remarks}}"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
